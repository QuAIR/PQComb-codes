...
def link(
    JE: Tuple[Union[np.ndarray, torch.Tensor], str, Union[List[int], int], Union[List[int], int]],
    JF: Tuple[Union[np.ndarray, torch.Tensor], str, Union[List[int], int], Union[List[int], int]],
) -> Tuple[Union[np.ndarray, torch.Tensor], str, List[int], List[int]]:
...
def mutual_information(state: Union[np.ndarray, torch.Tensor, State],
                       dim_A: int, dim_B: int) -> Union[np.ndarray, torch.Tensor]:
