...
class PQCombNet:
    ...
    Args:
        ...
        ancilla: The number of qubit systems or the dimension list of the ancilla system.
        slot_dim: The number of qubits of the unitaries to be queried.
        ...
        train_mode: The mode to use for training, default is 'process'.
...
def _setup_parameters(
    ...
    Args:
        ...
        ancilla: The parameter 'ancilla_dim' also used in the quantum computation context.
        slot_dim: The number of qubits of the unitaries to be queried.
    ...
    if (
        ...
        print(
            (
                ...
                + (
                    f"aux_qubits: {self.ancilla_dim_list.__len__()}"
...
def _extract_highest_fidelity(data_directory, filename):
    ...
    num_qubits_U_values = df["slot_dim"].unique()
    ...
    for slot_dim in num_qubits_U_values:
        ...
        output_filename = f"fidelity_table_num_qubits_U_{slot_dim}.csv"
...
def _train_swap_circuit(
    ...
    """
    # check if the number of qubits for unitary operation is greater than or equal to the number of ancilla qubits
